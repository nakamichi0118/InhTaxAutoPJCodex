...
const convertFirestoreTimestamps = (data) => {
  ...
  if (typeof data.seconds === "number" && typeof data.nanoseconds === "number") {
    return new Date(data.seconds * 1e3);
  }
...
const StatusMessage = ({ loading, error, userId }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-white/90 backdrop-blur-sm shadow-xl rounded-xl", children: [
  ...
  userId && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500 mt-2 text-center", children: [
    "ユーザーID (データ保存先): ",
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs", children: userId })
  ] })
] });
const Modal = ({ children, title, isOpen, onClose, className = "max-w-lg" }) => {
  if (!isOpen) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50 p-4 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `bg-white rounded-xl shadow-2xl w-full ${className} transform transition-all duration-300 scale-100 opacity-100 flex flex-col max-h-[90vh]`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center p-4 border-b flex-shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-gray-800", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "text-gray-500 hover:text-gray-700 p-1 rounded-full hover:bg-gray-100 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 20 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 overflow-y-auto", children })
  ] }) });
};
const InputField = ({ label, id, type = "text", value, onChange, placeholder = "", required = false, icon: Icon2, className = "", inputMode = "text", pattern = null }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `mb-4 ${className}`, children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: id, className: "block text-sm font-medium text-gray-700 mb-1", children: label }),
  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    Icon2 && /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400", size: 18 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ...
        inputMode,
        pattern,
        className: `w-full p-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition duration-150 shadow-sm ${Icon2 ? "pl-10" : ""}`
      }
    )
  ] })
] });
const SelectField = ({ label, id, value, onChange, options, required = false, className = "" }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `mb-4 ${className}`, children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: id, className: "block text-sm font-medium text-gray-700 mb-1", children: label }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(
    "select",
    {
      ...
      children: options.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option.value, disabled: option.disabled, children: option.label }, option.value))
    }
  )
] });
const CurrencyInput = ({ label, id, value, onChange, isDeposit = false }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: id, className: "block text-sm font-medium text-gray-700 mb-1", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      isDeposit ? /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 text-green-500", size: 18 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 text-red-500", size: 18 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          id,
...
const MainButton = ({ children, onClick, Icon: Icon2, className = "bg-blue-600 hover:bg-blue-700", disabled = false, type = "button" }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "button",
  {
    onClick,
    disabled,
    ...
    children: [
      Icon2 && /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 20 }),
...
const ExportPDFButton = ({ elementId, fileName, title = "PDFに出力" }) => {
      ...
      if (totalRows === 0) {
        ...
        while (rowsProcessed < totalRows) {
          ...
          if (tableInClone) {
            ...
            if (headerRow) {
              if (headerRow.children[6]) headerRow.children[6].style.display = "none";
              if (headerRow.children[7]) headerRow.children[7].style.display = "none";
              if (headerRow.children[8]) headerRow.children[8].style.display = "none";
            }
    ...
    switch (exportStatus) {
      case "loading-libs":
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "ライブラリ準備中..." })
        ] });
      case "exporting":
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 16, className: "animate-spin" }),
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "PDF生成中..." })
        ] });
      case "error":
        return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "エラー" });
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end", children: [
    ...
    exportStatus === "error" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-600 mt-1", children: errorMessage })
  ] });
};
const EditTransactionModal = ({ isOpen, onClose, transaction, onUpdateTransaction }) => {
  const [date, setDate] = reactExports.useState("");
  const [withdrawal, setWithdrawal] = reactExports.useState("");
  ...
  const handleUpdateTransaction = async (e) => {
    ...
    try {
      ...
      console.error("Error updating transaction:", e2);
      setMessage(`更新エラー: ${e2.message}`);
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen, title: "取引情報の編集", onClose, className: "max-w-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleUpdateTransaction, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mb-4 text-sm text-gray-600", children: [
      "口座名: ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: transaction.accountName })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(MainButton, { type: "submit", Icon: Save, className: "w-full mt-4 bg-green-600 hover:bg-green-700", children: "変更を保存" })
  ] }) });
};
const AddAccountModal = ({ isOpen, onClose, onCreateAccount, caseName }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal, { isOpen, title: "新規取引口座の登録", onClose, children: [
    caseName && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-500 mb-3", children: [
      "案件: ",
      caseName
    ] }),
...
const ExportModal = ({ isOpen, onClose, accounts, transactions }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal, { isOpen, title: "データのエクスポート", onClose, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 mb-4", children: "すべての口座情報と取引履歴を一つのJSONファイルに書き出します。" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      InputField,
      {
        label: "ファイル名 (.json)",
    ...
    message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-sm mt-2", children: message }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MainButton, { onClick: handleExport, Icon: FileDown, className: "w-full mt-4 bg-teal-600 hover:bg-teal-700", children: "エクスポート実行" })
  ] });
};
const ImportModal = ({ isOpen, onClose, onImport, caseName }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal, { isOpen, title: "データのインポート", onClose, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-red-50 border-l-4 border-red-500 text-red-700 p-4 mb-4 rounded", role: "alert", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold", children: "【重要】データの復元に関する警告" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", children: [
        "この操作を行うと、",
        caseName ? `${caseName} に` : "",
        "現在登録されている",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "すべての口座と取引履歴が完全に削除" }),
        "され、 ファイルの内容に置き換わります。この操作は元に戻せません。"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block mb-2 text-sm font-medium text-gray-900", htmlFor: "file_input", children: "バックアップファイル(.json)を選択" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center h-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-3 text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "confirm-overwrite", className: "font-medium text-gray-900", children: "現在の全データが削除され上書きされることを理解し、インポートを続行します。" }) })
    ] }),
    message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `p-3 rounded-lg my-3 text-sm ${status === "error" ? "bg-red-100 text-red-700" : status === "success" ? "bg-green-100 text-green-700" : "bg-blue-100 text-blue-700"}`, children: message }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      MainButton,
      {
        onClick: handleImport,
        Icon: status === "processing" ? LoaderCircle : FileUp,
        className: "w-full mt-4 bg-red-600 hover:bg-red-700",
        disabled: !file || !isConfirmed || status === "processing",
        children: status === "processing" ? "処理中..." : "インポート実行"
      }
    )
  ] });
};
const PendingImportModal = ({
  ...
  const [newCaseNames, setNewCaseNames] = reactExports.useState({});
  if (!isOpen) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal, { isOpen, title: "未登録の口座候補", onClose, className: "max-w-3xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-600 mb-4", children: [
      caseName ? `${caseName} に` : "選択中の案件に",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            MainButton,
            {
              ...
              Icon: status === "applying" ? LoaderCircle : Save,
              className: "bg-blue-600 hover:bg-blue-700",
              disabled: status === "applying",
              children: status === "applying" ? "取り込み中…" : "選択中の案件に取り込む"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-blue-200 rounded-lg p-3 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-blue-900", children: "新しい案件として取り込む" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              MainButton,
              {
                ...
                disabled: status === "applying",
                children: status === "applying" ? "取り込み中…" : "新しい案件に登録"
              }
            )
          ] })
        ] })
    ...
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-600 bg-red-100 rounded-lg p-2 mt-3", children: error }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3 mt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "text-sm text-gray-600 underline", onClick: onManual, children: "手動で口座を登録する" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MainButton, { onClick: onClose, className: "bg-gray-600 hover:bg-gray-700", children: "閉じる" })
    ] })
  ] });
};
const AccountManagementContent = ({
  ...
  const sortedAccounts = reactExports.useMemo(() => {
    return [...accounts].sort((a, b) => (a.order || 9999) - (b.order || 9999));
  }, [accounts]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-bold text-gray-800 border-b pb-2 flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: caseName ? `${caseName} の口座管理` : "取引口座の登録・管理と並べ替え" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MainButton, { Icon: Plus, onClick: onAddAccountClick, className: "bg-green-600 hover:bg-green-700 px-4 py-2 text-base", children: "新規口座を登録" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "登録されている口座を一覧表示し、ドラッグ＆ドロップの代わりに上下ボタンで表示順序を変更できます。" }),
    message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `p-3 rounded-lg my-3 text-sm ${message.includes("エラー") ? "bg-red-100 text-red-700" : "bg-green-100 text-green-700"}`, children: message }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-100 p-4 rounded-lg flex items-center justify-start space-x-4 border border-gray-200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-gray-700", children: "データ管理:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MainButton, { Icon: FileDown, onClick: () => setShowExportModal(true), className: "bg-teal-600 hover:bg-teal-700 px-4 py-2 text-sm", children: "エクスポート" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MainButton, { Icon: FileUp, onClick: () => setShowImportModal(true), className: "bg-red-600 hover:bg-red-700 px-4 py-2 text-sm", children: "インポート" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-lg font-semibold mb-3 text-gray-700", children: [
        "登録済み口座 (",
        accounts.length,
        "件)"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 p-2 bg-gray-50 rounded-xl shadow-inner max-h-[50vh] overflow-y-auto", children: [
        sortedAccounts.map((acc, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 md:flex-row md:items-center md:justify-between bg-white p-4 rounded-lg border border-gray-200 shadow-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-3 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col space-y-0.5 border-r pr-3", children: [
        ...
        accounts.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 text-center py-6", children: "まだ口座が登録されていません。上のボタンから登録してください。" })
      ] })
    ] })
  ] });
};
const TransactionTabContent = ({ account, transactions, onCreateTransaction, onDeleteTransaction, setEditingTransaction }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-bold text-gray-800 border-b pb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-600", children: account.name }),
      " の取引入力"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSaveTransaction, className: "bg-white p-6 rounded-xl shadow-md border border-gray-100", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end items-center mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MainButton, { type: "submit", Icon: Save, className: "w-1/3 bg-blue-600 hover:bg-blue-700", children: "この取引を登録" }) }),
      message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `p-3 rounded-lg my-3 text-sm ${message.includes("エラー") ? "bg-red-100 text-red-700" : "bg-green-100 text-green-700"}`, children: message })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "bg-white divide-y divide-gray-200", children: transactions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: totalColumns, className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center", children: "取引履歴はありません。" }) }) : transactions.map((t, index) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: `${rowClass} transition duration-150`, children: [
        ...
        showReorderColumn && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-1 py-3 whitespace-nowrap text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
          ...
          index < transactions.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => onReorder(t, transactions[index + 1]),
              title: "下へ移動",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3 whitespace-nowrap text-center text-sm font-medium", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => onEdit({ ...t, accountName: account == null ? void 0 : account.name }),
...
const IntegratedTabContent = ({
  ...
  const integratedTransactions = reactExports.useMemo(() => {
    return [...allTransactions].sort((a, b) => {
      var _a, _b;
      const orderA = (_a = a.userOrder) != null ? _a : new Date(a.date).getTime();
      const orderB = (_b = b.userOrder) != null ? _b : new Date(b.date).getTime();
      if (orderA !== orderB) {
  ...
  const handleReorderTransaction = async (movedItem, adjacentItem) => {
    ...
    try {
      ...
      const nextOrder = nextItem ? (_b = nextItem.userOrder) != null ? _b : new Date(nextItem.date).getTime() : null;
      let newOrder;
      if (prevOrder !== null && nextOrder !== null) {
        newOrder = (prevOrder + nextOrder) / 2;
      } else if (prevOrder !== null) {
        newOrder = prevOrder + 1e3;
      } else if (nextOrder !== null) {
        newOrder = nextOrder - 1e3;
      } else {
        return;
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-6", id: "integrated-transactions-area", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center border-b pb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-bold text-gray-800 flex items-center space-x-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownUp, { size: 24, className: "text-purple-600" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "統合取引一覧 (手動並べ替え対応)" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ExportPDFButton,
        {
          elementId: "integrated-transactions-area",
          fileName: `統合取引一覧_${(/* @__PURE__ */ new Date()).toISOString().substring(0, 10)}`
        }
      )
    ] }),
...
const LedgerApp = () => {
  ...
  const [selectedCaseId, setSelectedCaseId] = reactExports.useState(null);
  const [accounts, setAccounts] = reactExports.useState([]);
  const [transactions, setTransactions] = reactExports.useState([]);
  const [activeTab, setActiveTab] = reactExports.useState("register");
  const [showAddAccountModal, setShowAddAccountModal] = reactExports.useState(false);
  ...
  const [jobImportMappings, setJobImportMappings] = reactExports.useState({});
  ...
  const initialCaseIdRef = reactExports.useRef(new URLSearchParams(window.location.search).get("case_id"));
  const callLedgerApi = reactExports.useCallback(async (path, options = {}) => {
    if (!sessionToken) {
  ...
  const refreshState = reactExports.useCallback(
    async (caseIdOverride = null, showSpinner = true) => {
      ...
      try {
        ...
        if ((_a2 = data.case) == null ? void 0 : _a2.id) {
  ...
  const fetchCases = reactExports.useCallback(async () => {
    if (!sessionToken) return [];
    ...
    setSelectedCaseId((current) => {
      var _a2;
      return current || initialCaseIdRef.current || ((_a2 = fetchedCases[0]) == null ? void 0 : _a2.id) || null;
    });
    return fetchedCases;
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      ...
      const targetCaseId = initialCaseIdRef.current || ((_a2 = list[0]) == null ? void 0 : _a2.id);
      if (targetCaseId) {
  ...
  const convertAssetsToLedgerPayload = reactExports.useCallback((entry) => {
    ...
    ((entry == null ? void 0 : entry.assets) || []).forEach((asset, index) => {
      ...
      const name = (asset == null ? void 0 : asset.asset_name) || (entry == null ? void 0 : entry.name) || holderName || `口座${index + 1}`;
      accounts2.push({
        id: accountId,
        name,
  ...
  const handleReorderAccounts = reactExports.useCallback(async (items) => {
  ...
  const handleDeleteAccount = reactExports.useCallback(async (accountId) => {
  ...
  const handleUpdateTransaction = reactExports.useCallback(async (transactionId, payload) => {
  ...
  const handleDeleteTransaction = reactExports.useCallback(async (transactionId) => {
    await callLedgerApi(`/transactions/${transactionId}`, { method: "DELETE" });
    await refreshState(selectedCaseId, false);
  }, [callLedgerApi, refreshState, selectedCaseId]);
  const handleReorderTransactions = reactExports.useCallback(async (items) => {
  ...
  const handleUpdateTransactionColor = reactExports.useCallback(async (transactionId, rowColor) => {
    await callLedgerApi(`/transactions/${transactionId}`, {
      method: "PATCH",
      body: { rowColor }
    });
  ...
  const handleImportData = reactExports.useCallback(async (payload) => {
    if (!selectedCaseId) {
      throw new Error("案件が選択されていません。");
    }
  ...
  const handleJobMappingChange = reactExports.useCallback((assetId, updates) => {
  ...
  const handleImportPendingEntry = reactExports.useCallback(
    async (entry, { targetCaseId, newCaseName: newCaseName2 } = {}) => {
      ...
      const caseIdToUse = newCaseName2 ? null : targetCaseId || selectedCaseId;
      if (!caseIdToUse && !newCaseName2) {
        throw new Error("案件が選択されていません。");
      }
  ...
  const renderContent = () => {
    ...
    if (loading || !sessionToken) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatusMessage, { loading, error, userId }) });
    }
    if (activeTab === "register") {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          accounts,
          caseName: (_a2 = cases.find((item) => item.id === selectedCaseId)) == null ? void 0 : _a2.name,
          setShowExportModal,
          setShowImportModal,
    ...
    if (accounts.length === 0) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 text-center text-gray-600", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold", children: "はじめに、取引口座を登録しましょう" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2", children: [
          "上の「",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-blue-600", children: "設定・並べ替え" }),
          "」タブ、または右上の「",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-green-600", children: "新規口座を登録" }),
          "」ボタンから、最初の口座を追加してください。"
        ] })
      ] });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 text-center text-gray-600", children: "表示する口座を選択してください。" });
  };
  const TabButton = ({ tabId, label, Icon: Icon2, className = "", badge = 0, number = null }) => {
    const isActive = activeTab === tabId;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => setActiveTab(tabId),
        className: `flex flex-col items-start space-y-0.5 px-4 py-3 text-sm font-semibold rounded-t-lg transition-all duration-200 focus:outline-none ${className} ${isActive ? "bg-white text-blue-600 border-b-4 border-blue-600 shadow-t-lg" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
            Icon2 && /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 18 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: label }),
            badge > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-xs bg-red-500 text-white rounded-full h-5 w-5 flex items-center justify-center", children: badge })
          ] }),
          number && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-normal text-gray-400 ml-[22px] -mt-1", children: [
            "No. ",
            number
          ] })
        ]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#f1f5f9] font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "relative overflow-hidden text-white border-b border-[#102345]", style: { background: "linear-gradient(135deg, #050d26 0%, #0d2765 55%, #15418f 100%)" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto py-7 px-4 sm:px-6 lg:px-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.32em] text-[#c7d2fe]", children: "SOROBOCR LEDGER" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl font-extrabold flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(List, { size: 30, className: "text-[#93c5fd]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "入出金検討表ツール" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[rgba(224,231,255,0.9)] mt-1 max-w-2xl", children: "SOROBOCRで読み取ったCSV/JSONをRailway上のLedger APIに同期し、ブラウザだけで仕分け・比較・出力まで完了できます。" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto mt-6 px-4 sm:px-6 lg:px-8", children: [
      ...
      jobPreview && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-yellow-50 border border-yellow-200 rounded-2xl p-5 mb-5 space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 md:grid-cols-2", children: jobPreview.accounts.map((account) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-yellow-200 rounded-xl p-4 space-y-3 shadow-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-lg font-semibold text-gray-900", children: account.accountName || "預金口座" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500", children: [
                "口座番号: ",
                account.accountNumber || "不明"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500", children: [
                "取引件数: ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center space-x-2 text-sm", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "新規口座として登録" })
              ] }),
              config.mode === "new" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-2 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "text",
                    value: (_b2 = (_a2 = config.accountName) != null ? _a2 : account.accountName) != null ? _b2 : "",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center space-x-2 text-sm", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "既存口座とマージ" })
              ] }),
              config.mode === "merge" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  ...
                  className: "p-2 border rounded-md text-sm",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "既存口座を選択" }),
                    accounts.map((acc) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: acc.id, children: [
                      acc.name,
                      " / ",
                      acc.number || "番号なし"
                    ] }, acc.id))
        ...
        jobImportError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-600 bg-red-100 border border-red-200 rounded-lg p-2", children: jobImportError }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex border-b border-gray-200 overflow-x-auto whitespace-nowrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TabButton,
          {
            tabId: "register",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "bg-white rounded-b-xl shadow-xl min-h-[60vh]", children: renderContent() })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AddAccountModal,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatusMessage, { loading: loading && !error, error, userId }) })
  ] });
};
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LedgerApp, {});
}
